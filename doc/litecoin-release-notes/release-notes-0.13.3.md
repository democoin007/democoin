DemoCoin Core version 0.13.3 is now available from:

  <https://download.democoin.org/democoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/democoin-project/democoin/blob/0.13/src/chainparams.cpp#L214).
