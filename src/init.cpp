...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/democoin-project/democoin>";
    const std::string URL_WEBSITE = "<https://democoin.org>";
