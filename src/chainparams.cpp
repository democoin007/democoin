...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.democoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.democointools.com", true);
        vSeeds.emplace_back("dnsseed.democoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.democointools.com", true);
        vSeeds.emplace_back("seed-b.democoin.loshan.co.uk", true);
