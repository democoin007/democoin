...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s democoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  democoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded democoin transaction") + "\n" +
              "  democoin-tx [options] -create [commands]   " + _("Create hex-encoded democoin transaction") + "\n" +
              "\n";
