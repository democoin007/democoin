...
const char * const BITCOIN_CONF_FILENAME = "democoin.conf";
const char * const BITCOIN_PID_FILENAME = "democoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DemoCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DemoCoin";
#else
    // Unix
    return pathRet / ".democoin";
#endif
#endif
}
